...
**
** C:\RSA_API_Apps>R3FtoIQ ?
** --- R3FtoIQ: v3.11.0 (Aug 10 2017 13:12:11) --- RSA-API: v3.11.0039.0 --- RunAt: 2017/08/10 13:13:20 ---
...
** - File output: Path\Filename base = "d:\data\R3FtoIQ" (.tiq ext will be appended)
