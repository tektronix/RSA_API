...
**
** C:\RSA_API_Apps>DPXcapture ?
** --- DPXcapture: v3.11.0 (Aug 10 2017 13:33:23) --- RSA-API: v3.11.0039.0 --- RunAt: 2017/08/10 13:34:59 ---
...
**   vunit=<vertunits>     Vertical Units: 0=>dBm(def),1=>Watt,2=Volt,3=Amp)
...
**   pers=<persisttime>    Persist Time (def=1.0, infinite: < 0.0)
