...
**
** C:\RSA_API_Apps>AudioOut ?
** --- AudioOut: v3.11.0 (Aug 10 2017 13:20:09) --- RSA-API: v3.11.0039.0 --- RunAt: 2017/08/10 13:20:37 ---
...
**********************************************************
**
** Demo: Play and record 10 seconds of live signal Audio samples to ASCII file from an FM radio signal, at 200 kHz BW
