...
**
** C:\SignalVu-PC Files>SAcapture ?
** --- SAcapture: v3.9.0 (Sep 12 2016 16:58:26) --- RSA-API: v3.9.0029.0 --- RunAt: 2016/09/14 11:14:45 ---
...
**   vunits=<vertunit>     Vertical Units: 0=>dBm(def),1=>Watt,2=Volt,3=Amp,4=dBmV)
