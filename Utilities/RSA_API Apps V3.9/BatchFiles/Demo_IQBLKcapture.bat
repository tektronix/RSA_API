...
**
** C:\SignalVu-PC Files>IQBLKcapture ?
** --- IQBLKcapture: v3.9.0 (Sep 12 2016 16:59:04) --- RSA-API: v3.9.0029.0 --- RunAt: 2016/09/14 11:06:35 ---
...
**   na=<numacqs>          Number Of Blk Acqs (def=1)
